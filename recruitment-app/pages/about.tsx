    ...
    <DefaultPage header="About us" user={user}>
      ...
      <div className="about_container">
        <ul className="about">
          <li>
            <a
              href="https://www.linkedin.com/in/william-axbrink/"
              target="_blank"
            >
              William Axbrink{" "}
              <span
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/william-r%C3%A5gstad-79787988/"
              target="_blank"
            >
              William Rågstad{" "}
              <span
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/ludvig-lind%C3%A9n-1691a2193/"
              target="_blank"
            >
              Ludvig Lindén{" "}
              <span
